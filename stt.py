    ...
    def _regenerate_request_url(self):
        if self.api_key and self.language:
            query = urllib.parse.urlencode({'output': 'json',
                                      ...
                                      'maxresults': 6,
                                      'pfilter': 2})
            self._request_url = urllib.request.urlunparse(
...
class WitAiSTT(AbstractSTTEngine):
    ...
    def __init__(self, access_token):
        ...
        self.wit_ac_tok = 'SN27YSMQHVLPR5YKDHJJJVDQ2OKVYQKQ'
    ...
    def token(self, value):
        self._token = value
        self._headers = {'authorization': 'Bearer SN27YSMQHVLPR5YKDHJJJVDQ2OKVYQKQ',
                         'content-type': 'audio/wav'} #'rate':'16000','endian':'little'}
    ...
    def transcribe(self, fp):
        ...
        try:
            ...
            transcribed = []
            if len(text) > 0:
                print("Appending %s to transcribed"%(text))
